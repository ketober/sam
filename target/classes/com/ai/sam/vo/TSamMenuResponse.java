...
@Data
@ApiModel
public class TSamMenuResponse  extends ResponseParent{
	@ApiModelProperty(name = "DATA", value = "", required = true, example = "")
	@JsonProperty("DATA")
	private List<TSamMenu> data = new ArrayList<TSamMenu>();
	public TSamMenuResponse() {}
	public TSamMenuResponse(Page<TSamMenu> pageResult) {
