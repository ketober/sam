...
@Data
@ApiModel
public class TSamServiceSystemResponse  extends ResponseParent{
	@ApiModelProperty(name = "DATA", value = "", required = true, example = "")
	@JsonProperty("DATA")
	private List<TSamServiceSystem> data = new ArrayList<TSamServiceSystem>();
	public TSamServiceSystemResponse() {}
	public TSamServiceSystemResponse(Page<TSamServiceSystem> pageResult) {
