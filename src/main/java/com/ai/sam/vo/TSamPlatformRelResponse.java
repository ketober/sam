...
@Data
@ApiModel
public class TSamPlatformRelResponse  extends ResponseParent{
	@ApiModelProperty(name = "DATA", value = "", required = true, example = "")
	@JsonProperty("DATA")
	private List<TSamPlatformRel> data = new ArrayList<TSamPlatformRel>();
	public TSamPlatformRelResponse() {}
	public TSamPlatformRelResponse(Page<TSamPlatformRel> pageResult) {
