...
@Data
@ApiModel
public class TSamDistrictConfigResponse  extends ResponseParent{
	@ApiModelProperty(name = "DATA", value = "", required = true, example = "")
	@JsonProperty("DATA")
	private List<TSamDistrictConfig> data = new ArrayList<TSamDistrictConfig>();
	public TSamDistrictConfigResponse() {}
	public TSamDistrictConfigResponse(Page<TSamDistrictConfig> pageResult) {
