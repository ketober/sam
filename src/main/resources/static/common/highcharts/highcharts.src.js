...
// encapsulated variables
    ...
    Fx.prototype = {
        ...
        initPath: function (elem, fromD, toD) {
            ...
            // Copy and append last point util the length matches the end length
            if (start.length) {
                ...
                if (imageSize) {
                    ...
                    createElement('img', {
                        onload: function () {
                            ...
                            // Special case for SVGs on IE11, the width is not accessible util the image is
    ...
    if (useCanVG) {
         ...
         * the implementation from SvgRenderer will not be merged in util first render.
         */
    ...
    Axis.prototype = {
         ...
         * updated axis.pointRange or series.pointRange. The data can't be processed util
    ...
    extend(Highcharts.Pointer.prototype, {
        ...
        pinch: function (e) {
            ...
            // Don't initiate panning util the user has pinched. This prevents us from
    ...
    Chart.prototype = {
        ...
        redraw: function (animation) {
            ...
            // Fire callbacks that are put on hold util after the redraw
        ...
        /**
         * VML namespaces can't be added util after complete. Listening
        ...
        isReadyToRender: function () {
            ...
            if ((!hasSVG && (win == win.top && doc.readyState !== 'complete')) || (useCanVG && !win.canvg)) { // eslint-disable-line eqeqeq
                if (useCanVG) {
                    // Delay rendering util canvg library is downloaded and ready
                ...
                this.label =
                    this.axis.chart.renderer.text(str, null, null, options.useHTML)        // dummy positions, actual position updated with setOffset method in columnseries
                        ...
                        .attr({
                            ...
                            visibility: HIDDEN                    // hidden util setOffset is called
                        })
    ...
    */
        ...
        update: function (options, redraw, animation, runEvent) {
            ...
            function update() {
                ...
                if (isObject(options) && !isArray(options)) {
                    // Defer the actual redraw util getAttribs has been called (#3260)
    ...
    if (seriesTypes.pie) {
        seriesTypes.pie.prototype.drawDataLabels = function () {
            ...
            // Do not apply the final placement and draw the connectors util we have verified
