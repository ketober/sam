...
vjs.Component.prototype.initChildren = function(){
  ...
  if (options && options['children']) {
    ...
    vjs.obj.each(options['children'], function(name, opts){
      ...
      // Allow waiting to add components util a specific event is called
 ...
 * known, and in the case of Flash, may not be known util the video starts
 * playing.
 *
...
vjs.Flash = vjs.MediaTechController.extend({
  ...
  init: function(player, options, ready){
    ...
    if (options['iFrameMode'] === true && !vjs.IS_FIREFOX) {
      ...
      // Wait util iFrame has loaded to write into it.
...
vjs.TextTrack.prototype.parseCues = function(srcContent) {
  ...
  for (var i=1, j=lines.length; i<j; i++) {
    ...
    if (line) { // Loop util a line with content
      ...
      // Loop util a blank line or end of lines
